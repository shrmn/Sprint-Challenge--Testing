...
> `describe()` breaks the test suite into components. `it()` is where you perform individual tests.
...
> I think TDD is a good approach. It helps make sure requirements are met, and forces you to make sure each piece of your application is working before moving onto the next.
